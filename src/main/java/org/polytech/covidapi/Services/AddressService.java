...
public class AddressService {
    ...
    @Autowired
    public AddressService(AddressRepository addressRepository, Counter createAddressCounter, Histogram updateAddressDuration){
    ...
    public Address updateAddress(Integer addressId, Address updatedAddress){
        Histogram.Timer timer = updateAddressDuration.startTimer();
        try {
