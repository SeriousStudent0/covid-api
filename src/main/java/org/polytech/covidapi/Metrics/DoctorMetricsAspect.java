...
@Component
@Aspect
public class DoctorMetricsAspect {

    private final MeterRegistry registry;

    @Autowired
    public DoctorMetricsAspect(MeterRegistry registry) {
        this.registry = registry;
    }

    // Success counter of the executed method among all from AddressService
    @AfterReturning("execution(public * org.polytech.covidapi.Services.DoctorServices.*(..))")
    ...
    @AfterThrowing("execution(public * org.polytech.covidapi.Services.DoctorServices.*(..))")
    ...
    @Around("execution(public * org.polytech.covidapi.Services.DoctorServices.*(..))")
