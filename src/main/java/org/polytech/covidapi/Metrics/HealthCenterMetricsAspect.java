...
@Component
@Aspect
public class HealthCenterMetricsAspect {

    private final MeterRegistry registry;

    @Autowired
    public HealthCenterMetricsAspect(MeterRegistry registry) {
        this.registry = registry;
    }

    // Success counter of the executed method among all from AddressService
    @AfterReturning("execution(public * org.polytech.covidapi.Services.HealthCenterServices.*(..))")
    ...
    @AfterThrowing("execution(public * org.polytech.covidapi.Services.HealthCenterServices.*(..))")
    ...
    @Around("execution(public * org.polytech.covidapi.Services.HealthCenterServices.*(..))")
