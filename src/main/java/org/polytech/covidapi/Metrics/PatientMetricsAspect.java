...
@Component
@Aspect
public class PatientMetricsAspect {

    private final MeterRegistry registry;

    @Autowired
    public PatientMetricsAspect(MeterRegistry registry) {
        this.registry = registry;
    }

    // Success counter of the executed method among all from AddressService
    @AfterReturning("execution(public * org.polytech.covidapi.Services.PatientServices.*(..))")
    ...
    @AfterThrowing("execution(public * org.polytech.covidapi.Services.PatientServices.*(..))")
    ...
    @Around("execution(public * org.polytech.covidapi.Services.PatientServices.*(..))")
